        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                function addApiKeyAuthorization() {
                    ...
                    if (key && key.trim() != "") {
                        var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization("api_token", key, "query");
                        window.swaggerUi.api.clientAuthorizations.add("api_token", apiKeyAuth);
                        log("added key " + key);
                    }
                }
