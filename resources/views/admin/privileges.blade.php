...
@section('content')
    ...
    <div  style="width:750px;margin:0 auto ">
            ...
            <div class="box box-primary">
				...
				<form method='post' action='{{ (@$row->id)?route("AdminUserRolesControllerPostEditSave")."/$row->id":route("AdminUserRolesControllerPostAddSave") }}'>
                ...
                <div class="box-body">
					...
					<div class='form-group'>
						<label>{{trans('crudbooster.set_as_admin')}}</label><br/>
						<div id='set_as_admin'>
							<label  class='radio inline'>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input required {{ (@$row->is_admin==1)?'checked':'' }} type='radio' name='is_admin' value='1'/> {{trans('crudbooster.confirmation_yes')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input {{ (@$row->is_admin==0)?'checked':'' }} type='radio' name='is_admin' value='0'/> {{trans('crudbooster.confirmation_no')}}</label>
						</div>
							...
							$(function() {
								...
								$('#set_as_superadmin input').click(function() {
									...
									if(n == '1') {
										...
										if ( $('#set_as_admin input:checked').val() == 1 ){
								...
								$('#set_as_admin input').click(function() {
									var n = $(this).val();
									if(n == '1') {
										// if ( $('#set_as_admin input:checked') )
										$('#privileges_configuration').show();
									}else{
										$('#privileges_configuration').hide();
									}
								...
								$('#set_as_admin input:checked').trigger('click');
							})
						</script>								
					</div>
