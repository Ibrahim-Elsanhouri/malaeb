<?php namespace App\Http\Controllers;
	...
	class AdminHomedatasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Title','name'=>'title','type'=>'text','validation'=>'required|string|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'image','name'=>'url','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10'];
			# OLD END FORM
