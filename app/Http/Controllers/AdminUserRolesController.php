...
use CRUDBooster;
	...
	class AdminUserRolesController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"الإسم","name"=>"name");
		...
		$this->col[] = array("label"=>"يستطيع الدخول الى لوحة التحكم","name"=>"is_admin",'callback_php'=>'($row->is_admin)?"<span class=\"label label-success\">نعم</span>":"<span class=\"label label-default\">لا</span>"');

		$this->form   = array();
		$this->form[] = array("label"=>"الإسم","name"=>"name",'required'=>true);
		// $this->form[] = array("label"=>"Is Superadmin","name"=>"is_superadmin",'required'=>true);				
		$this->form[] = array("label"=>"يستطيع الدخول الى لوحة التحكم","name"=>"is_admin",'required'=>true);				
		$this->form[] = array("label"=>"لون لوحة التحكم","name"=>"theme_color",'required'=>true);		
	}
	...
	public function getAdd()
	{
		...
		$this->cbView('admin.privileges',$data);
	}
	...
	public function getEdit($id)
	{
		...
		return view('admin.privileges',compact('row','page_title','moduls','page_menu'));
		// $this->cbView('admin.privileges',$data);		
	}
