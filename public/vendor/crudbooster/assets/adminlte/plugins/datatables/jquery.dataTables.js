...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "لا توجد بيانات في الوقت الحالي." )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default لا توجد بيانات في الوقت الحالي.
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "لا توجد بيانات في الوقت الحالي."
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "لا توجد بيانات في الوقت الحالي.",
